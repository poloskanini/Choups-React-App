...
const products = [
  { name: 'Droit du travail', description: 'Lorem ipsum dolor sit amet consectur', href: '#', icon: ChartPieIcon },
  { name: 'Licenciement', description: 'Lorem ipsum dolor sit amet consectur', href: '#', icon: CursorArrowRaysIcon },
  { name: 'Défense du salarié', description: 'Lorem ipsum dolor sit amet consectur', href: '#', icon: FingerPrintIcon },
  { name: 'Droit Sécurité Sociale', description: 'Lorem ipsum dolor sit amet consectur', href: '#', icon: SquaresPlusIcon },
  { name: 'Prud\'hommes', description: 'Lorem ipsum dolor sit amet consectur', href: '#', icon: ArrowPathIcon },
]
const callsToAction = [
  { name: 'Le cabinet en vidéo', href: '#', icon: PlayCircleIcon },
